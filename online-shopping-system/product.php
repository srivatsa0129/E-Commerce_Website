				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">$'.$row['product_price'].'<del class="product-old-price">$.6,000.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>Asus lapop with 8GB RAM, 256GB SSD, intel i7 11th gen, 4GB graphic card</p>
